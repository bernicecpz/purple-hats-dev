...
? What would you like to scan today? Website
? Do you want purple-hats to run in the background? Yes
? Do you need to login to your website? Yes
? Please enter URL of website:  https://the-internet.herokuapp.com/login
? Please enter your login ID:  tomsmith
...
Please enter “username field” selector:  #username
? Please enter “login password field” selector:  #login
? Please enter “submit button field” selector:  #login > button > i
